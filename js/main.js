...
// TASK1.freight 1 dən kiçik olan sifarişləri console-a yazdır

// console.log(results.filter(item => item .order.freight < 1));

// TASK2.customerID ERNSH olan neçə ədəd sifariş var?

// console.log(results.filter(item => item .order.customerId == "ERNSH"));

// TASK3.employeeİd- görə sortlayın

// console.log(results.sort((a, b) => a.order.employeeId-b.order.employeeId));

// TASK4.OrderDetailsi 3-dən çox olanları console-a yazdır

// console.log(results.filter(item => item .orderDetails.length > 3));

// TASK5.İD-si 11075 olanı tap və yazdır. (find)
